...
const CLIMATE_PROFILES: Record<string, DestinationClimateProfile> = {
  bali: {
    ...
    climateOverview:
      'Gentle offshore ocean breezes with crystal clear sunny skies and warm evenings.',
    sunrise: '06:12 AM',
    sunset: '06:28 PM',
    rainyLikelihood: 12,
    generalPacking: [
  ...
  vietnam: {
    ...
    climateOverview:
      'Comfortable humidity, crisp morning mist over Ha Long Bay, and golden afternoon sun in Hoi An.',
    sunrise: '05:48 AM',
    sunset: '06:05 PM',
    rainyLikelihood: 15,
    generalPacking: [
  ...
  kashmir: {
    ...
    climateOverview:
      'Refreshing pine mountain air with chilly twilight temperatures and warm sunny afternoons.',
    sunrise: '05:35 AM',
    sunset: '07:15 PM',
    rainyLikelihood: 10,
    generalPacking: [
      'Pashmina/Woolen stole',
      'Thermal inner layer for night',
      'Trekking boots',
      'Windcheater jacket',
  ...
  goa: {
    ...
    climateOverview:
      'Endless blue skies, warm Arabian sea breezes, and postcard-perfect 6 PM golden hours.',
    sunrise: '06:18 AM',
    sunset: '06:45 PM',
    rainyLikelihood: 8,
    generalPacking: [
  ...
  amalfi: {
    ...
    climateOverview:
      'Cobalt skies over the Tyrrhenian sea with balmy lemon-scented coastal breezes.',
    sunrise: '06:05 AM',
    sunset: '07:50 PM',
    rainyLikelihood: 8,
    generalPacking: [
      'Italian linen trousers',
      'Sturdy walking shoes for cliff steps',
      'Chic sunglasses',
      'Light cardigan for yachting',
  ...
  kyoto: {
    ...
    climateOverview:
      'Temperate and clear, ideal for temple strolling and bamboo grove morning walks.',
    sunrise: '05:15 AM',
    sunset: '06:35 PM',
    rainyLikelihood: 18,
    generalPacking: [
      'Easy slip-on walking shoes',
      'Layered light sweater',
      'Pocket rain poncho',
      'Daypack for shrines',
  ...
  dubai: {
    ...
    generalPacking: [
      ...
      'Light scarf for AC interiors',
      'Desert evening jacket',
      'Hydration pack',
    ],
  },
  phuket: {
    ...
    climateOverview:
      'Calm turquoise seas, vibrant sunshine, and gentle evening breeze perfect for night markets.',
    sunrise: '06:20 AM',
    sunset: '06:35 PM',
    rainyLikelihood: 14,
    generalPacking: [
  ...
  ladakh: {
    ...
    generalPacking: [
      ...
      'SPF 50+ zinc cream',
      'UV 400 sunglasses',
      'Thermals for Pangong night',
      'Electrolyte hydration sachets',
    ],
  },
  jaipur: {
    baseTempC: 27,
    ...
    climateOverview:
      'Pleasant daytime exploration weather with cool desert evenings around fort courtyards.',
    sunrise: '06:00 AM',
    sunset: '06:40 PM',
    rainyLikelihood: 5,
    generalPacking: [
      'Comfortable cotton kurtas/shirts',
      'Walking sneakers',
      'Sun hat for fort climbs',
      'Light shawl for evening dining',
      'Moisturizer',
    ],
  },
};
...
const DEFAULT_PROFILE: DestinationClimateProfile = {
  ...
  climateOverview:
    'Mild and pleasant conditions with optimal visibility and comfortable sightseeing temperatures.',
  sunrise: '06:00 AM',
  sunset: '06:30 PM',
  rainyLikelihood: 10,
  generalPacking: [
...
export function generateDestinationWeatherForecast(
  ...
  for (let i = 0; i < daysCount; i++) {
    ...
    const conditionObj =
      WEATHER_CONDITIONS[(i + destinationName.length) % WEATHER_CONDITIONS.length];
    const precip = Math.max(5, Math.round(profile.rainyLikelihood + ((i * 4) % 15) - 5));
    const humidity =
      profile.climateType === 'tropical'
        ? 68 + (i % 8)
        : profile.climateType === 'desert'
          ? 28 + (i % 5)
          : 52 + (i % 6);
...
export async function fetchDestinationWeatherForecast(
  ...
  return generateDestinationWeatherForecast(
    destinationId,
    destinationName,
    country,
    durationDays,
